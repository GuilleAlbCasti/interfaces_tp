...
// Esta clase maneja las reglas del juego y coordina con el Tablero
...
class Model {
  ...
  // Selecciona una ficha en la posición (row, col)
  ...
  tieneMovimientosValidos() {
    // PASO 1: Recorrer TODO el tablero (7 filas x 7 columnas)
    for (let row = 0; row < 7; row++) {
      for (let col = 0; col < 7; col++) {
        
        // PASO 2: Si encontramos una ficha, verificar si puede moverse
        if (this.tablero.tieneFicha(row, col)) {
          
          // PASO 3: Verificar las 4 direcciones posibles
          // Para moverse necesita: ficha adyacente + espacio vacío detrás
          
          // ⬆️ ARRIBA: ¿Puede saltar hacia arriba?
          ...
          // ⬇️ ABAJO: ¿Puede saltar hacia abajo?
          ...
          // ⬅️ IZQUIERDA: ¿Puede saltar hacia la izquierda?
          ...
          // ➡️ DERECHA: ¿Puede saltar hacia la derecha?
    ...
    // PASO 4: Si llegamos aquí, no encontramos NINGÚN movimiento válido
    return false  // ❌ No hay más jugadas posibles - FIN DEL JUEGO
  }
